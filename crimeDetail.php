...
"SELECT username, reportID, title, data_created, time, description, avg_rating, x_coordinate, y_coordinate , CategoryName 
  FROM (SELECT Report_Detail.reportID, userID, title, data_created, time, Report_Detail.description, avg_rating , CategoryName, Report_Detail.x_coordinate, Report_Detail.y_coordinate
      FROM (SELECT   C.reportID, userID, title, data_created, time, description, avg_rating, C.x_coordinate, C.y_coordinate
        FROM (
          SELECT Crime_Location.reportID, userID, title, data_created, time, description, avg_rating, Crime_Location.x_coordinate, Crime_Location.y_coordinate
  ...
  $query_params = array(
      ':report_identifier' => $_POST['reportId']
  );
  try{
...
//echo $_REQUEST['json'];
  ...
  <form action="crimeDetail.php" method="post">
    <table>
      <tr>
        <td>x_coordinate</td>
